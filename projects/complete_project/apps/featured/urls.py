...
urlpatterns = patterns('',
	...
	url(r'^starfish/country/create/$', 'featured.views.countrycreate', name='star_country_create'), 
	url(r'^starfish/country/edit/(?P<page_slug>[\w\-]+)/$', 'featured.views.countryedit',name='star_country_edit'),
	url(r'^starfish/country/(?P<page_slug>[\w\-]+)/$', 'featured.views.countrydetail', name='star_country_detail'),    
